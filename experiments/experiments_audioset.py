...
window_sizes = [3, 5, 1]
mask_types = ['mv_noise']
alphas = [0.1] # alphas = [0.01, 0.05, 0.1, 0.5, 1]
...
# ]
mask_configs = [ 
    {"sum_mv_noise_0.01": {"mask_percentage": [0.2, 0.3, 0.4], "possible_windows": [1,3,5], "possible_mask_types": ['sum_mv_noise'], "possible_std_noise": [0.01], "combinations": 9}},
    {"sum_mv_noise_0.05": {"mask_percentage": [0.2, 0.3, 0.4], "possible_windows": [1,3,5], "possible_mask_types": ['sum_mv_noise'], "possible_std_noise": [0.05], "combinations": 9}},
    {"sum_mv_noise_0.1": {"mask_percentage": [0.2, 0.3, 0.4], "possible_windows": [1,3,5], "possible_mask_types": ['sum_mv_noise'], "possible_std_noise": [0.1], "combinations": 9}},
