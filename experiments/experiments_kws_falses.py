...
LABELS_PATH = '/home/ec2-user/explain_where/datasets/kws/kws_fp_dataset.csv'
SEGMENT_LENGTH = 100
NUM_SAMPLES = 1000
            ...
            for i in tqdm(range(len(df))):
                ...
                try:
                    generate_explanation(
                        ...
                        id_to_explain=0,
                        config=mask_config,
                        path='/home/ec2-user/explanations/explanations_kws_fp'
                    )
...
LABELS_PATH = '/home/ec2-user/explain_where/datasets/kws/kws_fn_dataset.csv'
df = pd.read_csv(LABELS_PATH)
for mask_type in mask_types:
    for window_size in window_sizes: 
        for mask_percentage in mask_percentages:
            ...
            for i in tqdm(range(len(df))):
                ...
                try:
                    generate_explanation(
                        ...
                        id_to_explain=0,
                        config=mask_config,
                        path='/home/ec2-user/explanations/explanations_kws_fn'
                    )
                except Exception as e:
                    print(f"Error generating explanation for {filename}: {e}")
